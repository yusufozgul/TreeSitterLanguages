...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "TreeSitterTSX", cSettings: [.headerSearchPath("tsx/src")]),
        .target(name: "TreeSitterTSXQueries", resources: [.copy("queries")]),
        .target(name: "TreeSitterTypeScript", cSettings: [.headerSearchPath("typescript/src")]),
